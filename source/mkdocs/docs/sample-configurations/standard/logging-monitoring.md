...
It should be noted that certain categories of network flows are not captured, including traffic to and from the instance metadata service (`169.254.169.254`), and DNS traffic with an Amazon VPC DNS resolver. DNS logs are available by configuring [Route 53 Resolver query logs](../../../typedocs/interfaces/___packages__aws_accelerator_config_lib_models_network_config.IResolverConfig.html#queryLogs).
