...
!!!note "See also"
    [AWS Network Firewall configuration reference](../../typedocs/interfaces/packages__aws-accelerator_config_lib_models_network-config.INfwConfig.html)
...
!!!note "See also"
    [Firewall configuration reference](../../typedocs/interfaces/packages__aws-accelerator_config_lib_models_network-config.INfwFirewallConfig.html)