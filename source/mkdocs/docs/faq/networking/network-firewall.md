...
!!!note "See also"
    [AWS Network Firewall configuration reference](../../typedocs/interfaces/___packages__aws_accelerator_config_dist_config_lib_models_network_config.INfwConfig.html)
...
!!!note "See also"
    [Firewall configuration reference](../../typedocs/interfaces/___packages__aws_accelerator_config_dist_config_lib_models_network_config.INfwFirewallConfig.html)