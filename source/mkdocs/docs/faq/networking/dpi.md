...
!!!note "See also"
    * [Route table configuration reference](../../typedocs/interfaces/___packages__aws_accelerator_config_lib_models_network_config.ITransitGatewayRouteTableConfig.html)
