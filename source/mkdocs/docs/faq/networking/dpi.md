...
!!!note "See also"
    * [Route table configuration reference](../../typedocs/interfaces/packages__aws-accelerator_config_lib_models_network-config.ITransitGatewayRouteTableConfig.html)
