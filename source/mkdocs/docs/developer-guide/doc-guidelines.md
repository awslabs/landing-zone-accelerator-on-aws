...
* Content Ordering:
    ...
    * Description of class/property:
        ...
        * Include links to public AWS documentation when relevant to do so. For example, link to the [What is Amazon VPC?](https://docs.aws.amazon.com/vpc/latest/userguide/what-is-amazon-vpc.html) documentation for the [VPCConfig](../typedocs/interfaces/packages__aws-accelerator_config_lib_models_network-config.IVpcConfig.html) class.
...
The following example contains all of the necessary content as an example for the top-level class description for [IpamPoolConfig](../typedocs/interfaces/packages__aws-accelerator_config_lib_models_network-config.IIpamPoolConfig.html) within [NetworkConfig](../typedocs/modules/packages__aws-accelerator_config_lib_models_network-config.html):
