...
import { GetCloudFormationTemplatesModule } from '../../../dist/lib/aws-cloudformation/get-cloudformation-templates';
...
describe('GetCloudFormationTemplatesModule Contract Compliance', () => {
  ...
  let module: GetCloudFormationTemplatesModule;

  beforeEach(() => {
    module = new GetCloudFormationTemplatesModule();
  ...
  test('should handle invalid inputs according to contract', async () => {
    ...
    await expect(module.handler({} as IGetCloudFormationTemplatesHandlerParameter)).rejects.toThrow(
