...
describe('CreateOrganizationalUnitModule Contract Compliance', () => {
  ...
  let module: CreateOrganizationalUnitModule;

  beforeEach(() => {
    module = new CreateOrganizationalUnitModule();
  ...
  test('should handle invalid inputs according to contract', async () => {
    ...
    await expect(module.handler({} as ICreateOrganizationalUnitHandlerParameter)).rejects.toThrow(
