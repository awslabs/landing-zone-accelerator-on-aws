...
describe('Success', () => {
  ...
  test('Valid Organization Configuration ', async () => {
    expect(
      await Organization.validate(GlobalRegion, Region, SolutionId, Partition, {
  ...
  test('GovCloud Required Accounts Found', async () => {
    ...
    expect(
      await Organization.validate(GlobalRegion, Region, SolutionId, GovCloud_US, {
        logArchive: LogArchiveAccount.Email,
        audit: AuditAccount.Email,
      }),
    ).toBeUndefined();
...
describe('Failure', () => {
  ...
  test('Organization Not Enabled', async () => {
    ...
    await expect(
      Organization.validate(GlobalRegion, Region, SolutionId, Partition, {
        logArchive: LogArchiveAccount.Email,
        audit: AuditAccount.Email,
      }),
  ...
  test('GovCloud Required Accounts Not Found', async () => {
    ...
    await expect(
      Organization.validate(GlobalRegion, Region, SolutionId, GovCloud_US, {
        logArchive: LogArchiveAccount.Email,
        audit: AuditAccount.Email,
      }),
