...
const externalAccountTesterStack = new TesterStack(app, `${qualifierInPascalCase}-TesterStack-${account}-${region}`, {
...
/**
 * TesterStack construct test
 */
describe('TesterStack', () => {
  /**
   * Number of ConfigRule resource test
   */
  test(`${testNamePrefix} ConfigRule resource count test`, () => {
    cdk.assertions.Template.fromStack(externalAccountTesterStack).resourceCountIs('AWS::Config::ConfigRule', 1);
  });
  ...
  test(`${testNamePrefix} Lambda function resource count test`, () => {
    cdk.assertions.Template.fromStack(externalAccountTesterStack).resourceCountIs('AWS::Lambda::Function', 1);
  });
  ...
  test(`${testNamePrefix} Lambda permission resource count test`, () => {
    cdk.assertions.Template.fromStack(externalAccountTesterStack).resourceCountIs('AWS::Lambda::Permission', 1);
  });
  ...
  test(`${testNamePrefix} Lambda IAM role resource count test`, () => {
    cdk.assertions.Template.fromStack(externalAccountTesterStack).resourceCountIs('AWS::IAM::Role', 1);
  });
  ...
  test(`${testNamePrefix} Lambda IAM policy resource count test`, () => {
    cdk.assertions.Template.fromStack(externalAccountTesterStack).resourceCountIs('AWS::IAM::Policy', 1);
  });
  ...
  test(`${testNamePrefix} ConfigRule awsacceleratorvalidatemaintransitgatewayCustomRule resource configuration test`, () => {
    cdk.assertions.Template.fromStack(externalAccountTesterStack).templateMatches({
      Resources: {
