 ...
 */
export class SecurityHubOrganizationAdminAccount extends cdk.Construct {
  public readonly id: string;

  constructor(scope: cdk.Construct, id: string, props: SecurityHubOrganizationalAdminAccountProps) {
    super(scope, id);
