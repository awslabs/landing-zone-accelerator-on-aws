...
describe('SsmParameter', () => {
  ...
  /**
   * Custom resource SsmParameter configuration test
   */
  ...
  /**
   * Custom resource provider framework lambda function IAM role policy configuration test
   */
  test(`${testNamePrefix} Custom resource provider framework lambda function IAM role policy configuration test`, () => {
    cdk.assertions.Template.fromStack(stack).templateMatches({
      Resources: {
        SsmParameterCustomResourceProviderframeworkonEventServiceRoleDefaultPolicyF43DF488: {
          Type: 'AWS::IAM::Policy',
  ...
  /**
   * Custom resource provider framework lambda function IAM role configuration test
   */
  test(`${testNamePrefix} Custom resource provider framework lambda function IAM role configuration test`, () => {
    cdk.assertions.Template.fromStack(stack).templateMatches({
      Resources: {
        SsmParameterCustomResourceProviderframeworkonEventServiceRoleE1067FDA: {
          Type: 'AWS::IAM::Role',
