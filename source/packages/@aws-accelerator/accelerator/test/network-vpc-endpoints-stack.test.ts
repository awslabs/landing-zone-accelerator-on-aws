 ...
 */
const acceleratorTestStacks = new AcceleratorSynthStacks(AcceleratorStage.NETWORK_VPC_ENDPOINTS, 'all-enabled', 'aws');
...
describe('NetworkVpcEndpointsStack', () => {
  ...
  test(`${testNamePrefix} SSM parameter custom resource count test`, () => {
    cdk.assertions.Template.fromStack(stack).resourceCountIs('AWS::SSM::Parameter', 17);
  });
  ...
  //         Properties: {
  //           Name: '/accelerator/AWSAccelerator-NetworkVpcEndpointsStack-111111111111-us-east-1/stack-id',
  //           Type: 'String',
  //           Value: {
  //             Ref: 'AWS::StackId',
  //           },
