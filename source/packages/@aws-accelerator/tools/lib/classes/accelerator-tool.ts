...
export class AcceleratorTool {
  ...
  private pipelineStageActions: {
  ...
  }[] = [
    {
      ...
      order: 7,
      actions: [
        { order: 8, name: 'Finalize', stackPrefix: '-FinalizeStack' },
        { order: 7, name: 'Customizations', stackPrefix: '-CustomizationsStack' },
        { order: 6, name: 'Network_Associations', stackPrefix: '-NetworkAssociationsStack' },
        { order: 6, name: 'Network_Associations', stackPrefix: '-NetworkAssociationsGwlbStack' },
        { order: 3, name: 'Security_Resources', stackPrefix: '-SecurityResourcesStack' },
        { order: 5, name: 'Network_VPCs', stackPrefix: '-NetworkVpcDnsStack' },
        { order: 4, name: 'Network_VPCs', stackPrefix: '-NetworkVpcEndpointsStack' },
        { order: 3, name: 'Network_VPCs', stackPrefix: '-NetworkVpcStack' },
        { order: 2, name: 'Operations', stackPrefix: '-OperationsStack' },
