...
2. Download the tar file from the [GitHub repository](https://github.com/awslabs/landing-zone-accelerator-on-aws/archive/refs/tags/experimental-v1.15.0-rc.6/lza-v1.15.0-rc.6-al2023.tar.gz).
...
```
docker load < lza-v1.15.0-rc.6-al2023.tar.gz
```
5. Tag the image
`docker tag lza-v1.15.0-rc.6-al2023:latest <aws_account_id>.dkr.ecr.<region>.amazonaws.com/landing-zone-accelerator-on-aws:latest`
