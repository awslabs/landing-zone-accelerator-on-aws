...
| ImageUri | `public.ecr.aws/aws-solutions/landing-zone-accelerator-on-aws:1.15.0-rc.13` | The Amazon Elastic Container Registry (Amazon ECR) repository, where Landing Zone Accelerator on AWS code is present. |
